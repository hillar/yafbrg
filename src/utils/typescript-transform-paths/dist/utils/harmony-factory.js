            ...
            switch (prop) {
                ...
                case "updateImportClause":
                    return function (node, isTypeOnly, name, namedBindings) {
                        return tsThreeInstance.updateImportClause.apply(void 0, (0, ts_type_conversion_1.downSampleTsTypes)(node, name, namedBindings));
                    };
                case "updateExportDeclaration":
                    return function (node, decorators, modifiers, isTypeOnly, exportClause, moduleSpecifier) {
                        const [dsNode, dsModuleSpecifier, dsExportClause] = (0, ts_type_conversion_1.downSampleTsTypes)(node, moduleSpecifier, exportClause);
